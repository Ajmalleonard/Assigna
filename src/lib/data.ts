...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 8, 26, 15, 0),
    end: new Date(2024, 8, 26, 18, 0),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2024, 8, 23, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 8, 27, 11, 0),
    end: new Date(2024, 8, 27, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 8, 27, 13, 0),
    end: new Date(2024, 8, 27, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 8, 27, 14, 0),
    end: new Date(2024, 8, 27, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 8, 30, 9, 0),
    end: new Date(2024, 8, 30, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 9, 1, 10, 0),
    end: new Date(2024, 9, 1, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 8, 25, 11, 0),
    end: new Date(2024, 8, 27, 11, 45),
  },
  {
    title: "History",
  ...
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 9, 4, 9, 0),
    end: new Date(2024, 9, 4, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 9, 4, 11, 0),
    end: new Date(2024, 9, 4, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
